...
function Message({ message }) {
  ...
  // check this message is users message 
  ...
  return (
    <div className={`flex items-end space-x-2 relative ${isUserMessage && "justify-end" }`} >
      ...
      {/* message */}
      <div className={`flex space-x-4 p-3 rounded-lg ${ isUserMessage ? "rounded-br-none bg-pink-300" : "rounded border-l-none bg-blue-400" }`} >
